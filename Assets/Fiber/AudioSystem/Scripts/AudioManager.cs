...
namespace Fiber.AudioSystem
{
	public class AudioManager : Singleton<AudioManager>
	{
		...
		{
			get => PlayerPrefs.GetInt(PlayerPrefsNames.IsSoundMuted, 0).Equals(1);
			set => PlayerPrefs.SetInt(PlayerPrefsNames.IsSoundMuted, value ? 1 : 0);
		}
		public bool IsMusicMuted
		{
			get => PlayerPrefs.GetInt(PlayerPrefsNames.IsMusicMuted, 0).Equals(1);
			set => PlayerPrefs.SetInt(PlayerPrefsNames.IsMusicMuted, value ? 1 : 0);
		}
