...
namespace Fiber.Build.ProjectConfig
{
	...
	public class ProjectConfig : ScriptableObject
	{
		...
		[SerializeField] private Sprite loadingScreen;
		[PropertySpace(0, 20)]
		[SerializeField] private Sprite loadingScreenTitle;

		private readonly Texture2D[] _icons = new Texture2D[19];
		...
		public void Apply()
		{
			...
			for (var i = 0; i < 19; i++)
				_icons[i] = productIcon;

			PlayerSettings.SetIcons(NamedBuildTarget.iOS, _icons, IconKind.Any);
			...
			PlayerSettings.bundleVersion = iOSVersion = androidVersion;
		...
		private void SetLoadingScreen()
		{
			...
			loadingPanel.SetLoadingScreen(background, loadingScreen, loadingScreenTitle);
		...
		private void ChangeReadMe()
		{
			...
			{
				// Add icons here
				var iconList = new List<Object> { productIcon, loadingScreen };
